...
graveColorTexture.repeat.set(0.3, 0.2)
graveARMTexture.repeat.set(0.3, 0.2)
graveNormalTexture.repeat.set(0.3, 0.2)
...
const ghost1Animation = (elapsedTime) => {
    const ghostAngle = elapsedTime * 0.4
    const ghostPositionX = Math.cos(ghostAngle) * 5 
    const ghostPositionY = Math.sin(ghostAngle) * 5
    ghost1.position.x = ghostPositionX
    ghost1.position.z = ghostPositionY
    ghost1.position.y = Math.sin(elapsedTime) * Math.sin(elapsedTime * 2.34) * Math.sin(elapsedTime * 3.45)
}

const ghost2Animation = (elapsedTime) => {
    const ghostAngle = - elapsedTime * 0.3
    const ghostPositionX = Math.cos(ghostAngle) * 4
    const ghostPositionY = Math.sin(ghostAngle) * 4
    ghost2.position.x = ghostPositionX
    ghost2.position.z = ghostPositionY
    ghost2.position.y = Math.sin(elapsedTime) * Math.cos(elapsedTime * 2.34) * Math.sin(elapsedTime * 3.45)
}

const ghost3Animation = (elapsedTime) => {
    const ghostAngle = elapsedTime * 0.2
    const ghostPositionX1 = Math.cos(ghostAngle) * 4.5
    const ghostPositionY1 = Math.sin(ghostAngle) * 4.5
    const ghostPositionX2 = Math.cos(elapsedTime * 1.3)
    const ghostPositionY2 = Math.sin(elapsedTime * 1.3)
    ghost3.position.x = ghostPositionX1 + ghostPositionY2
    ghost3.position.z = ghostPositionY1 + ghostPositionY2
    ghost3.position.y = Math.sin(elapsedTime * 1.23) * Math.sin(elapsedTime ) * Math.sin(elapsedTime * 3.45)
}
...
const tick = () =>
{
    ...
    ghost1Animation(elapsedTime)
    ghost2Animation(elapsedTime)
    ghost3Animation(elapsedTime)
